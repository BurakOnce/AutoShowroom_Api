using AutoShowroom_UI.Dtos.BottomGridDtos;
...
namespace AutoShowroom_UI.Controllers
{
    public class BottomGridController : Controller
    {
            ...
            public async Task<IActionResult> CreateBottomGrid(CreateBottomGridDto createBottomGridDto)
            {
                ...
                var responseMessage = await client.PostAsync("https://localhost:44337/api/BottomGrids", stringContent);
                if (responseMessage.IsSuccessStatusCode)
                {
            ...
            {
                var client = _httpClientFactory.CreateClient();
                var reponseMessage = await client.DeleteAsync($"https://localhost:44337/api/BottomGrids/{id}");
            ...
            public async Task<IActionResult> UpdateBottomGrid(UpdateBottomGridDto updateBottomGridDto)
            {
                ...
                StringContent stringContent = new StringContent(jsonData, Encoding.UTF8, "application/json");
                var responseMessage = await client.PutAsync("https://localhost:44337/api/BottomGrids/", stringContent);
                if (responseMessage.IsSuccessStatusCode)
                {
                    return RedirectToAction("Index");
                }
